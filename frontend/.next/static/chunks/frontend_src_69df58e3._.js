...
const getExpenses = async ()=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/expenses");
    return response.data;
};
const addExpense = async (expense)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/expenses", expense);
    return response.data;
};
...
"[project]/frontend/src/app/components/AddExpenseForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AddExpenseForm() {
    ...
    const [amount, setAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
...
_s(AddExpenseForm, "Yyyg6+5R1braTwdI58PABWa+mBY=");
_c = AddExpenseForm;
var _c;
...
//# sourceMappingURL=frontend_src_69df58e3._.js.map